...
bool Cell_Make_Extension_Bigp_cpp(double** x, int** r, const int nrow, const int ncol, double* d_k,
	...
	const int i_merge, const int i_collapsing, const int i_SIS_type,
...

	{
		...
		*/
		...
		bool b_success_nDAU = nDAU_Bigp_cpp_MPI(uox, mox, i_count_uox, i_count_mox, nrow, ncol, i_collapsing, i_SIS_type,
			...
			v_nD, List_nU, tnU, codes, correlation_yicheng, correlation_ranking, b_DEBUG_nDAU, TestOut, i_loop);
